...
| contract 1.4 / `production-book-1` target | Yes through ADR-0035: base/media, math/safe-vector, metadata/language/outline, and tagged PDF/PDF/UA-1 validation | Partial private staging through MI4-07: semantic container/base media, SafeVector, math, and metadata/navigation; tagged structure remains MI4-09 | No; public CLI remains 1.3/seven-profile | No, MI4-13 gate |
