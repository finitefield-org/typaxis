...
| contract 1.4 / `production-book-1` target | Yes through ADR-0036: base/media, math/safe-vector, metadata/language/outline, tagged PDF/PDF/UA-1 validation, and separate baseline-JPEG/CFF1 components | Private semantic-container/base-media, SafeVector, math, metadata/navigation, and tagged-PDF slices through MI4-09; JPEG/CFF remain MI4-11/12 | No; public CLI remains 1.3/seven-profile | No, MI4-13 gate |
