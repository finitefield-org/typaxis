...
| contract 1.4 / `production-book-1` target | Yes, ADR-0032 base plus ADR-0033 math/safe-vector decision | Private MI4-02 semantic-container/base-media, MI4-04 SafeVector admission/PDF, and MI4-05 math source/vector/alternative slices; remaining M4 slices pending | No; current aliases remain 1.3 | No, MI4-13 gate |
