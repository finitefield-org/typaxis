...
| contract 1.4 / `production-book-1` target | Yes, ADR-0032 base, ADR-0033 math/safe-vector, and ADR-0034 metadata/language/outline decisions | Private MI4-02 semantic-container/base-media, MI4-04 SafeVector, MI4-05 math, and MI4-07 metadata/language/outline through PDF validation; remaining M4 slices pending | No; current aliases remain 1.3 | No, MI4-13 gate |
...
| machine package ingestion | stable-byte admission, strict decoder, sealed source validation, and session-bound receipts are implemented; `WireDocumentPackage` remains untrusted; target 1.4 adds semantic container, required declared media, explicit math nodes/source/alternative, safe-vector media, document metadata/language, and explicit outline | public 1.0/1.1/1.2/1.3 DocumentPackage input and current 1.3 output; target 1.4 remains public `P1103` | ADR-0027, ADR-0028, ADR-0031 through ADR-0034, docs/02,19,25,26, contracts/phase-ownership | current independent Schema/semantic validation, typed round trip, and public E2E; MI4-02/04/05/07 implement private slices, and MI4-13 is the atomic gate |
