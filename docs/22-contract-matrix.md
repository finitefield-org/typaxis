...
| contract 1.3 advanced-pagination target | Yes, ADR-0031 | Partial: private header/footer DTO, Schema, owners, and artifacts; columns/float pending | No; current aliases remain 1.2 | No, MI3-12 gate |
...
| machine PDF capability | exact public `PARAGRAPH_1`, `BASIC_DOCUMENT_1`, `FOOTNOTE_1`, and `TABLE_1` descriptors with matching preflight receipts; MI3-09 adds a private session/limits-bound header/footer preflight receipt while all three ADR-0031 public IDs remain reserved | current 1.2 capability Schema and canonical four-profile fixture; future 1.3 adds conditional advanced descriptor members | contracts/machine-pdf-capabilities, ADR-0027, ADR-0028, ADR-0029, ADR-0030, ADR-0031, docs/26 | current bidirectional descriptor/fixture closure and release gates; future three combined fixtures/default/old-descriptor freeze at MI3-12 |
...
| advanced-pagination targets | MI3-09 implements private checked master/trim/page-box owners, canonical first/left/right selection, independent header/footer FlowIds, dense repetition, selected/display/PDF/manifest closure, and session/limits-bound receipts; column/balance/float owners remain pending and no public Rust dispatch exists | private `schemas/1.3/` covers the advanced DocumentPackage additions and exact `machine-advanced-pagination-manifest`; current aliases and public output remain byte-frozen at 1.2 | ADR-0031, contracts/machine-pdf-capabilities, contracts/phase-ownership, docs/10,25 | MI3-09 combined/empty/oversize private fixture gate; MI3-10/11 private slice gates, then MI3-12 bidirectional fixtures, G6003/G6004 exact/max+1, tamper, PDF-box/raster, reproducibility, old-profile rejection, and documented-host gates |
