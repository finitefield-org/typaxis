...
| contract 1.3 advanced-pagination profiles | Yes, ADR-0031 target | Partial: private `header-footer-1` and `columns-1`; float pending | No; public IDs rejected | No, MI3-12 gate |
