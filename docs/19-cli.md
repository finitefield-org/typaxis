...
| contract 1.3 advanced-pagination profiles | Yes, ADR-0031 target | Yes: private `header-footer-1`, `columns-1`, and `float-1` vertical slices | No; public IDs rejected | No, MI3-12 gate |
