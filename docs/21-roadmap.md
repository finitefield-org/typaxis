...
| M4 contract 1.4 / `production-book-1` assembled target | Yes through ADR-0034 for base/media, math/safe-vector, and metadata/language/outline; later tagging/JPEG/OTF-CFF decisions pending | Partial private MI4-02/04/05 slices; metadata/navigation remains MI4-07 | No; current public surface remains 1.3 | No, MI4-13 gate |
