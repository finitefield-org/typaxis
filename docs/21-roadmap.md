...
| --- | --- | --- | --- | --- |
| bounded reference TSF pipeline | Yes, current 1.4 | Yes, reference subset | Yes | No |
| DocumentPackage portable Schema and `dump-ast` export | Yes, current 1.4 plus frozen 1.0/1.1/1.2/1.3 input | Yes: independent registries and resource-attested export | Yes | Yes, MI4-13 gate |
...
| contract 1.3 generated artifacts | Yes | Yes, frozen output with frozen 1.0/1.1/1.2 input | Yes | Yes |
| M2 `basic-document-1` and M3 `table-1` / `footnote-1` | Yes, ADR-0028/0029/0030 | Yes | Yes, combined fixtures | Yes, profile gates |
| M3 `header-footer-1` / `columns-1` / `float-1` | Yes, ADR-0031 on frozen contract 1.3 | Yes: selected-state and artifact closure | Yes, combined fixtures | Yes, MI3-12 gate |
| M4 contract 1.4 / `production-book-1` | Yes through ADR-0037 for base/media, native math/safe-vector, producer-composed math vector, metadata/language/outline, tagged PDF/PDF/UA-1 validation, and distinct `jpeg-baseline`/`sfnt-cff1` resource components | Yes, complete receipt/artifact closure | Yes, combined public fixture | Yes, MI4-13 gate |
| remaining M5 gates | M4 publication is complete; M5 decisions remain assigned later | Pending by individual M5 milestone | No | No |
