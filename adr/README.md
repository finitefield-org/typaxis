...
- [ADR-0030: Footnote machine-PDF profile](ADR-0030-footnote-profile.md) — M3 footnote targetとしてAccepted。current contract 1.2上の`footnote-1`はMI3-07 publication gateまで非公開。
